    ...
    <div class="footer-links container-fluid">
        ...
        <div class="col-md-4">
          <div class="mainlinks">
            ...
            <ul>
              ...
              <li> 
                <a href="tel:8390446644" style="font-weight: 300;">
                 +91 83904 46644</a></li> 
              <li>
                <a href="mailto:enquiry@marutiseva.com" style="font-weight: 300;">
                enquiry@marutiseva.com</a>
              </li>
            </ul>
      ...
      <div class="col-md-4">
          <div class="mainlinks">
            ...
            <ul>
              <li style="color:#FFF">Promotions, new products and sales. Directly to your inbox.</li>
            </ul>
            <div class="newsletter-form mt-30 footer-newletter">
              <form method="post" action="get_updates.php" data-parsley-validate="true" >
                <div class="newsletter-form input-group">
                  <input type="text" placeholder="Enter Email Address" name="email_id" class="col-10" data-parsley-error-message="Please enter valid email." data-parsley-pattern="^([\w\-\.]+)@((\[([0-9]{1,3}\.){3}[0-9]{1,3}\])|(([\w\-]+\.)+)([a-zA-Z]{2,4}))$" required data-parsley-errors-container="#element">
    ...
    <div class="footer_bottom">
      <div class="container">
        <div class="float-left">
          <div class=" text-center"> © 2020 Seva Maruti Suzuki Commercial | Design by <a class="text-info" href="http://techrupt.in/" target="_blank">Techrupt.</a></div>
        </div>
        <div class="float-right">
          <ul class="f_list">
            <li><a href="disclaimer.php"f use');">Terms of use</a></li>
            <li><a href="/privacy.aspx" policy');">Privacy policy</a></li>
          </ul>
        </div>
      </div>
    </div>
